...
const Page = () => {
  ...
  <thead>
    <tr className='border-b'>
      ...
      <th className='text-left p-4 w-3/12'>파일명</th>
      <th className='text-left p-4 w-2/12'>단어 수</th>
      <th className='text-left p-4 w-3/12'>업로드 시간</th>
      <th className='text-left p-4 w-2/12'>문서 공개</th>
      <th className='text-left p-4 w-1/12'></th> 
    </tr>
  </thead>
  <tbody>
