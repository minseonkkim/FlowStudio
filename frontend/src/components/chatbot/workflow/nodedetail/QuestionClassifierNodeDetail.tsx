   ...
   <div className="flex flex-col gap-4 w-[300px] h-[calc(100vh-170px)] rounded-[20px] p-[20px] bg-white bg-opacity-40 backdrop-blur-[15px] shadow-[0px_2px_8px_rgba(0,0,0,0.25)] overflow-y-auto">
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-row items-center justify-between">
        <div className="bg-[#95A4CD] rounded-[360px] w-[50px] h-[50px] flex justify-center items-center z-[10]">
          <GrTree className="text-[#1E3A8A] size-7"/>
        </div>
        ...
        <div className="relative inline-block text-left">
          <div>
            <button
              type="button"
              className="inline-flex justify-center w-[160px] rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-[#95A4CD]"
