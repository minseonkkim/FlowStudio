...
export default function Header() {
  ...
  const MobileHeader = () => (
    <header className="z-20 fixed inset-0 w-full h-[57px] px-6 flex justify-between items-center border-b-[1px] bg-white">
      ...
      <Link href="/" onClick={handleLinkClick} className="flex items-center gap-3 absolute left-1/2 transform -translate-x-1/2">
      ...
      <nav
        className={`${
          isMenuOpen ? "fixed inset-0 top-[57px] flex flex-col items-start p-6 bg-white z-30" : "hidden"
